...
export class Preload extends Phaser.State {
  ...
  preload() {
    ...
    this.game.load.spritesheet(
        ...
        `assets/sprites/${CONFIG.PLAYER_SPRITESHEET}.png`, 32, 32);
    this.game.load.bitmapFont(
        CONFIG.TITLE_FONT, `assets/fonts/bitmapFonts/${CONFIG.TITLE_FONT}.png`,
        `assets/fonts/bitmapFonts/${CONFIG.TITLE_FONT}.xml`);
  ...
  loadStart() { console.log(this.load.progress); }
  updateProgress() { console.log(this.load.progress); }
}
